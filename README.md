...
1️⃣ Loading and Inspecting the Data
...
jupyter notebook
Open:
Impact_of_Technology_on_GDP_Growth.ipynb
Ensure the dataset file is in the same directory:
120-countries_gdp_growth.csv
📬 Support
If you need:
A polished PDF version
A GitHub-ready README formatting
A full research paper version
Visual dashboards (Power BI / Tableau / Python)
